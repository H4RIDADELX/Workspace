var texto = "Texto bem aleatorio dos atrasados da volta da pausa"
...
// templete string
// console.log(`${texto1} texto aleatorio ${texto2}`)
...
console.log("Trazer em minusculo :" + String03.toLowerCase ())
...
let textoTrocado = trocaTexto.replace("Roblox", "KlebinhoJogador2028")
